...
export function ChatHeaderSection({currentChatRoom}:ChatHeaderSectionProps) {
    const {name,users,code} = {...currentChatRoom}
    
    return <header className="w-full bg-[#151515] shadow-xl border flex justify-between items-center border-custom-border-color px-4 py-2 rounded-md">
